...
/**
 * Exception that is thrown if an error occurs when
 * the source for the Proxy class are created.
 *
 * @package TechDivision_AOP
 ...
 * @license GPL
 */
class TechDivision_AOP_Proxy_CreateException extends Exception
{
}